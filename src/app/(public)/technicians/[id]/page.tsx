...
async function TechnicianProfileContent({
  ...
  const technician: TechnicianProfile | null = techRes?.data?.result ?? null;
  ...
  const serviceAreas = technician.serviceArea ?? [];
                    ...
                    <div className="mt-3 flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-muted-foreground">
                      {technician.yearsOfExperience && (
                        <span className="flex items-center gap-1.5">
                          ...
                          {technician.yearsOfExperience} experience
                        </span>
                      )}
          ...
          <div className="mt-6 grid gap-6 lg:grid-cols-[minmax(0,1fr)_320px] lg:items-start">
            <div className="min-w-0 space-y-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="overflow-hidden rounded-lg border">
                      {availabilityEntries.map(([day, window], index) => (
                        <div key={day}>
              ...
              <Card>
                ...
                <CardContent>
                  <TechnicianServicesGrid services={services} />
                </CardContent>
              </Card>
            </div>
            ...
            <aside className="space-y-6 lg:sticky lg:top-6">
              ...
              <Card>
                <CardHeader>
                  <h2 className="font-semibold">Technician details</h2>
                </CardHeader>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-0.5 text-xs text-muted-foreground">
                        {technician.yearsOfExperience || "Not specified"}
                      </p>
                    </div>
                  </div>
              ...
              <Card className="bg-muted/30">
                <CardContent className="p-5">
                  ...
                  <p className="mt-1 text-sm leading-6 text-muted-foreground">
                    Browse the services below to view pricing, details, and
                    booking options.
                  </p>
                </CardContent>
              </Card>
