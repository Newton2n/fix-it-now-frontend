...
export function FinalCTA() {
  return (
    <section
      id="final-cta"
      className="w-full border-b border-border bg-background py-20 lg:py-28 overflow-hidden"
    >
            ...
            <div className="relative min-w-0 flex flex-col items-start">
              ...
              <div className="mt-8 flex w-full flex-wrap items-center gap-4">
                <Button
                  asChild
                  size="lg"
                  className="gap-2 px-8 py-6 text-base font-semibold shadow-sm transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
                >
                  <Link href="/services">
                    Find a Service
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="px-8 py-6 text-base font-semibold transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]"
                >
                  <Link href="/technicians">Explore Technicians</Link>
                </Button>
              </div>
            </div>
