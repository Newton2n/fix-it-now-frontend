...
import { cancelBooking } from "@/actions/bookings.action";
...
export default function CustomerBookingsClient({
  ...
  // Sync with server data when filters/pagination change
  useEffect(() => {
      ...
      <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
        <div className="min-w-0 flex-1 space-y-4">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <Info label="Your Note" value={booking.customerNote || "No note"} />
          ...
          {/* Review */}
          {booking.review && <ReviewSummary review={booking.review} />}
        </div>
...
function ReviewSummary({ review }: { review: NonNullable<Booking["review"]> }) {
  return (
